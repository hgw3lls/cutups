...
- `cutup_01_plan.json` should summarize section counts, top sources, transform tags, grid settings, `source_diversity`, `section_arc`, and per-section `section_targets`.
